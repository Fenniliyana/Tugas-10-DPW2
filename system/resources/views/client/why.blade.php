    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 mx-auto">
          <div class="box">
            <div class="img-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="500" height="512">
            ...
            <div class="detail-box">
              ...
              <p>
                Pengirimannya gratis untuk seluruh kalbar, dan untuk diluar kalbar akan dikenakan ongkos kirim sesuai jangkauan.pengirimannya melalui JNT dan JNE.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mx-auto">
          <div class="box">
            ...
            <div class="detail-box">
              ...
              <p>
                Barang yang tidak sesuai dengan pemesanan bisa melakukan pengajuan untuk pengembalian barang dan akan diganti sama owner nya.
              </p>
            </div>
          </div>
        </div>
      ...
      C436.008,462.478,438.013,456.472,435.546,451.531z" />
            ...
            <div class="detail-box">
              ...
              <p>
                 Toko GYMFen ini Adminnya fastrespon, ramah dan 24/7 melayani pesan dari pelanggan. jadi langsung tanya-tanya aja kalau ada hal yang ingin ditanyakan.
              </p>
            </div>
          </div>
        </div>
